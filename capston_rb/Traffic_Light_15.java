...
public class Traffic_Light_15 extends AppCompatActivity {

    private ImageView imageView;
    private int[] images = { R.drawable.light_15_r, R.drawable.light_15_1_g, R.drawable.light_15_2_g,};
    private int[] displayTimes = {35000, 22000, 19000};
