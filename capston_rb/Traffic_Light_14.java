...
public class Traffic_Light_14 extends AppCompatActivity {

    private ImageView imageView;
    private int[] images = {R.drawable.light_14_r, R.drawable.light_14_1_g, R.drawable.light_14_2_g};
    private int[] displayTimes = {110000, 23000, 17000};
    private int currentIndex = 0;
    private TextView timerTextView;
    private int[] timeArray = {110000, 23000, 17000}; // 각 이미지에 대한 타이머 시간 (밀리초 단위)
