...
public class Traffic_Light_7 extends AppCompatActivity {

    private ImageView imageView;
    private int[] images = {R.drawable.light_7_g, R.drawable.light_7_r};
    private int[] displayTimes = {30000, 130000}; // 각 이미지에 대한 표시 시간 (밀리초 단위)
    private int currentIndex = 0;
    private TextView timerTextView;
    private int[] timeArray = {30000, 130000}; // 각 이미지에 대한 타이머 시간 (밀리초 단위)
