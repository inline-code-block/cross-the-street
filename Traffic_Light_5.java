...
public class Traffic_Light_5 extends AppCompatActivity {

    private ImageView imageView;
    private int[] images = {R.drawable.light_5_g, R.drawable.light_5_r};
    //긴초 29, , ㅃㅃ 26, 짧초 35000
    private int[] displayTimes = {35000, 80000}; // 각 이미지에 대한 표시 시간 (밀리초 단위)
