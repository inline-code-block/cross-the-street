...
public class MainActivity_support_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_support_add);
        ...
        databaseReference = firebaseDatabase.getReference("board"); // "board"는 저장될 데이터의 경로
        ...
        findViewById(R.id.go_home).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity_support_add.this, MainActivity_support.class);
